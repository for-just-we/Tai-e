...
abstract public class DelegateHostSet implements HostSet {
    ...
    @Override
    public boolean contains(Host host) { return set.contains(host); }
    ...
    @Override
    public Set<Host> getHosts() { return Collections.unmodifiableSet(set); }

    @Override
    public Stream<Host> hosts() { return set.stream(); }
    ...
    @Override
    public HostSet copy() { return newSet(set.copy()); }
